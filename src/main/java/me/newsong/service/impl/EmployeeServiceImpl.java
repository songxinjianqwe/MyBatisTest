...
public class EmployeeServiceImpl implements EmployeeService {
    ...
    public PageInfo<EmployeeDO> findAllEmployees(int pageNum, int pageSize) {
        return empDao.findAllEmployees(pageNum, pageSize).toPageInfo();
    }
     ...
     * @Cacheable可以指定三个属性，value、key和condition。 value属性是必须指定的，其表示当前方法的返回值是会被缓存在哪个Cache上的，对应Cache的名称。
